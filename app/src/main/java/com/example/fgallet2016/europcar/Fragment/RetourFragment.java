 ...
 * {@link RetourFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link RetourFragment#newInstance} factory method to
...
public class RetourFragment extends Fragment {
     ...
     * @return A new instance of fragment RetourFragment.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate(R.layout.fragment_retour, container, false);

        ajouter_photo = v.findViewById(R.id.ajouter_photo);

        ajouter_photo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mListener.prendre_photo();
            }
        });
